...
export const TicketTable = () => {
  const { user, format_tickets, openAddTicketModal } = useHome();

  return (
    <div className=" flex flex-col justify-between my-2">
      <div className="inline-flex justify-between items-center px-4 py-2 gap-3">
      ...
      <div className="h-full overflow-scroll dark:bg-slate-800/15 dark:border dark:border-slate-300/5 text-slate-700 p-1 overflow-x-hidden no-scrollbar ">
